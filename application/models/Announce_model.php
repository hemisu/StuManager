...
//			$html.='<td>'.$val['list_order'].'</td>';
			...
			$html .= '<a href="javascript:if(confirm(\'确定要删除吗\'))window.location.href=\''.base_url('admin_announce/announce').'_delete/announce_id/'.$val['id'].'\';" class="btn btn-white btn-sm"><span class="glyphicon glyphicon-edit"></span> 删除</a></td>';
		}
		return $html;
	}
