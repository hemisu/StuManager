...
class Jw extends Base_Controller {
	...
	function __construct()
	{
		...
		$url = 'https://ez.zust.edu.cn/login';
		$post['user'] = '1130320108';
		$post['pass'] = 'woshidiandian';
		$this->ezcookie = '';
...
//	echo $results['cookie'];
	...
	private function getView(){
	  $res=array();
		$url = 'http://jwxt.zust.edu.cn.ez.zust.edu.cn/default2.aspx';
...
//		print_r($score);
	...
	public  function djks($xh,$pwd){
		$cookie = $this->login($xh,$pwd);
		$url = "http://jwxt.zust.edu.cn.ez.zust.edu.cn/xsdjkscx.aspx?xh=".$xh;
		$post['ddlXN'] = '';
		$post['ddlXQ'] = '';
		$result = $this->curl_request($url,$post,$cookie);
...
public function preg(){
	...
	public function mainpage(){
		$cookie = $this->login();
	     $url = 'http://jwxt.zust.edu.cn.ez.zust.edu.cn/xs_main.aspx?xh=1130320108';
	   $result = $this->curl_request($url,'',$cookie);  //我们保存的cookies
		 print_r($result);
	}
	public function kebiao(){
		$cookie = $this->login();
		$url = "http://jwxt.zust.edu.cn.ez.zust.edu.cn/xskbcx.aspx?xh=1130320108";
		$result = $this->curl_request($url,'',$cookie);
		// print_r($result);
  ...
  public  function getViewJs(){
      $url = "http://jwxt.zust.edu.cn.ez.zust.edu.cn/xxjsjy.aspx?xh=1130320108";
