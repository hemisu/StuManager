...
<!-- Main content -->
	<section class="content">
		<div class="row">
			<div class="col-md-3">
				<a href="<?echo base_url('/message/send');?>" class="btn btn-primary btn-block margin-bottom">Compose</a>
					...
					<div class="box-footer">
                        ...
                        <span class="mailbox-attachment-size">
                          ...
                          <a href="#" class="btn btn-default btn-xs pull-right"><i class="fa fa-cloud-download"></i></a>
							...
							<li>
								<span class="mailbox-attachment-icon has-img"><img src="<?echo base_url('/public/AdminLTE2/dist/img')?>/photo1.png" alt="Attachment"></span>
								<div class="mailbox-attachment-info">
                        ...
                        <span class="mailbox-attachment-size">
                          ...
                          <a href="#" class="btn btn-default btn-xs pull-right"><i class="fa fa-cloud-download"></i></a>
							...
							<li>
								<span class="mailbox-attachment-icon has-img"><img src="<?echo base_url('/public/AdminLTE2/dist/img')?>/photo2.png" alt="Attachment"></span>
								<div class="mailbox-attachment-info">
