					...
					<div class="col-sm-12">
						...
						<form id="infoForm" method="post" action="<?=current_url();?>" class="form-horizontal">
							...
							<div class="form-group">
								...
								<div class="col-xs-2">
									<p class="text-center"><strong>留校原因</strong></p>
								</div>
								<div class="col-xs-2">
								...
								<div class="col-xs-2">
									<p class="text-center"><strong>留校负责人</strong></p>
								</div>
								<div class="col-xs-1">
							...
							<div class="form-group">
								...
								<div class="col-xs-2">
									<select class="form-control" name="info[0][reason]">
										<option value="实验室实践">实验室实践</option>
								...
								<div class="col-xs-2">
									<input type="text" class="form-control" name="info[0][remark]" placeholder="留校负责人" />
								</div>
								<div class="col-xs-1">
							...
							<div class="form-group hide" id="infoTemplate">
								...
								<div class="col-xs-2">
									<input type="text" class="form-control" name="remark" placeholder="留校负责人" />
								</div>
								<div class="col-xs-1">
							...
							<div class="form-group">
								<div class="row">
									<div class="col-xs-12">
										<button type="submit" class="btn btn-info btn-block">提交留校人员</button>
									</div>
								</div>
							</div>
						</form>
