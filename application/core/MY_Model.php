...
class Base_Model extends MY_Model{
	 ...
	 *  设置表名
	 */
	function set_table_name($tablename='',$tablepre='')
	{
	 ...
	 * @return unknown_type
	 */
	final public function listinfo($where = '',$data='*', $order = '', $page = 1, $pagesize = 20, $key='', $setpages = 20,$urlrule = '',$array = array()) {
		$this->number = $this->count($where);//查询数目
