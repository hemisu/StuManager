...
$('#toolbar').find('select').change(function () {
	$('#user_library').bootstrapTable('refreshOptions', {
...
function operateFormatter(value, row, index) {
	return [
	'<a class="like" href="'+SITE_URL+'monitor/user_edit/'+row.student_id+'" title="Like">',
...
window.operateEvents = {
	...
	$.ajax({
	type: 'get',
	url: SITE_URL+'monitor/user_delete'+'/'+row.student_id,
